...
/system/bin/logcat -d | /system/bin/grep -e "Disabling NFC" -e "Enabling NFC" -e SeRFHandler_receive -e NFCSwipeActivity -e "whole hci is" -e "SeHciReceiver" \
 -e eid-hal -e eSEPower -e SecureElement -e eSE-HAL -e VSES -e NxpNci -e data_trace -e GPTEE -e GPMTEEC -e SecTeeCA -e QSEECOMPAT > /data/SecureElement/logData/log/mainlog
